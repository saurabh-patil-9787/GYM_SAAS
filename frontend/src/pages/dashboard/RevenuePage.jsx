        ...
        return (
            <div className="flex items-center justify-center h-full min-h-[60vh]">
                <div className="relative w-16 h-16">
                    <div className="absolute top-0 w-full h-full border-4 border-purple-500/30 rounded-full"></div>
                    <div className="absolute top-0 w-full h-full border-4 border-purple-500 rounded-full border-t-transparent animate-spin"></div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 md:space-y-8 animate-in fade-in zoom-in duration-500 w-full max-w-[100vw] overflow-x-hidden p-1 sm:p-2">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 w-full">
                ...
                {/* 1. Today Card */}
                <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gray-800/80 border border-green-500/50 shadow-[0_0_25px_rgba(34,197,94,0.2)] p-4 sm:p-5 md:p-6 cursor-default">
                    <div className="absolute top-0 right-0 p-8 opacity-20 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-bl from-green-400 to-transparent rounded-bl-full pointer-events-none scale-110"></div>
                    <div className="relative z-10 flex flex-col justify-between h-full gap-2">
                        <div className="flex justify-between items-start mb-2 md:mb-6">
                            <div className="bg-green-500/10 border border-green-500/30 p-2 sm:p-2.5 md:p-3 rounded-xl md:rounded-2xl text-green-400">
                                <Clock className="w-5 h-5 sm:w-6 sm:h-6" />
                            </div>
                            <span className="text-[8px] sm:text-[10px] font-bold px-2 py-1 bg-gray-800 text-green-300 rounded-full border border-green-500/20 uppercase tracking-widest shadow-sm">Today</span>
                        </div>
                        <div>
                            ...
                            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white flex items-center tracking-tight truncate">
                                <span className="text-green-500 mr-1 text-xl sm:text-2xl md:text-3xl lg:text-4xl">₹</span>
                ...
                {/* 2. This Month Card */}
                <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gray-800/80 border border-purple-500/50 shadow-[0_0_25px_rgba(168,85,247,0.2)] p-4 sm:p-5 md:p-6 cursor-default">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full gap-2">
                        <div className="flex justify-between items-start mb-2 md:mb-6">
                            <div className="bg-purple-500/10 border border-purple-500/30 p-2 sm:p-2.5 md:p-3 rounded-xl md:rounded-2xl text-purple-400">
                                <Calendar className="w-5 h-5 sm:w-6 sm:h-6" />
                            </div>
                            <span className="text-[8px] sm:text-[10px] font-bold px-2 py-1 bg-gray-800 text-purple-300 rounded-full border border-purple-500/20 uppercase tracking-widest shadow-sm">Monthly</span>
                        </div>
                        <div>
                ...
                {/* 3. Pending Dues Card */}
                <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gray-800/80 border border-red-500/50 shadow-[0_0_25px_rgba(239,68,68,0.2)] p-4 sm:p-5 md:p-6 cursor-default">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full gap-2">
                        <div className="flex justify-between items-start mb-2 md:mb-6">
                            <div className="bg-red-500/10 border border-red-500/30 p-2 sm:p-2.5 md:p-3 rounded-xl md:rounded-2xl text-red-500">
                                <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6" />
                            </div>
                            <span className="text-[8px] sm:text-[10px] font-bold px-2 py-1 bg-gray-800 text-red-300 rounded-full border border-red-500/20 uppercase tracking-widest shadow-sm">Pendings</span>
                        </div>
                        <div>
                ...
                <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gray-800/80 border border-cyan-500/50 shadow-[0_0_25px_rgba(6,182,212,0.2)] flex flex-col p-4 sm:p-5 md:p-6 h-[160px] sm:h-auto min-h-[150px] cursor-default">
                    ...
                    <div className="flex-1 flex items-end justify-between gap-1 sm:gap-2 px-1 pb-1 mt-1 relative z-10">
                        <div className="absolute inset-0 border-b border-dashed border-gray-700/50 pointer-events-none"></div>
            ...
            <div className="mt-6 md:mt-8 pb-10 w-full overflow-hidden">
                <div className="bg-gray-900/60 backdrop-blur-xl rounded-2xl md:rounded-3xl border border-gray-800 shadow-2xl transition hover:border-gray-700 flex flex-col w-full max-w-full">
                    <div className="p-5 md:p-6 border-b border-gray-800 bg-gray-900/40 flex flex-wrap justify-between items-center gap-3 px-4 md:px-8 shrink-0">
                        <h2 className="text-base sm:text-lg md:text-2xl font-black text-white flex items-center gap-3">
                            <div className="p-1.5 md:p-2 bg-pink-500/20 rounded-lg text-pink-400 drop-shadow-sm"><CreditCard size={18} className="md:h-5 md:w-5" /></div>
                            Recent Cashflows
                        </h2>
                        <span className="text-[9px] md:text-[10px] font-bold bg-gray-800 text-purple-300 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-gray-700 uppercase tracking-widest shadow-inner shadow-black/50">
                            Live Ledger
                        </span>
                    </div>
                    
                    <div className="overflow-x-auto w-full max-h-[400px] md:max-h-[500px] scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
                        {recentTransactions.length === 0 ? (
                            <div className="p-8 md:p-12 text-center text-gray-500 flex flex-col items-center justify-center min-h-[250px] md:min-h-[300px]">
                                <div className="p-4 md:p-6 bg-gray-800/50 rounded-full mb-4">
                                    <Clock size={36} className="text-gray-600 opacity-50 md:w-12 md:h-12" />
                                </div>
                            ...
                            <div className="w-full">
                                <table className="w-full text-left border-collapse">
                                    <thead className="bg-gray-900/90 text-gray-400 text-[10px] md:text-xs uppercase tracking-widest font-bold sticky top-0 z-10 box-shadow-sm">
                                        <tr>
                                    ...
                                    <tbody>
                                        {recentTransactions.map((tx, idx) => (
                                            <tr key={tx._id || idx} className="border-b border-gray-800/80 hover:bg-gray-800/60 transition-colors group">
                                                ...
                                                <td className="hidden sm:table-cell py-4 md:py-5 px-3 sm:px-4 md:px-8">
                                                    <span className={`px-2 py-1 md:px-3 md:py-1.5 text-[9px] md:text-[10px] font-black tracking-wider uppercase rounded-full shadow-sm whitespace-nowrap ${
                                                        tx.type === 'Online' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/30' : 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/30'
                                                    }`}>
                                                        {tx.type}
                                                    </span>
                                                </td>
