        ...
        <div className="flex flex-col h-full">
            <div className="p-6 space-y-6 flex-1">
                <div className="space-y-1">
                    <h2 className="text-2xl font-black text-white">Basic Info</h2>
                    <p className="text-gray-400 text-sm">Let's start with the essentials.</p>
                </div>
                
                <div className="space-y-5">
                    <div className="relative">
                        <label className="block text-gray-400 text-sm font-bold mb-2">Full Name <span className="text-red-500">*</span></label>
                        <div className="relative">
                    ...
                    <div className="relative">
                        <label className="block text-gray-400 text-sm font-bold mb-2">Mobile Number <span className="text-red-500">*</span></label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <input
                                ...
                                className={`w-full bg-gray-800 border text-white pl-12 pr-4 py-3.5 rounded-xl focus:outline-none transition-colors ${data.mobile.length > 0 && data.mobile.length < 10 ? 'border-red-500/50 focus:border-red-500 focus:ring-1 focus:ring-red-500' : 'border-gray-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500'}`}
                            />
                        </div>
            ...
            <StickyBottomBar>
                <button
                    ...
                    className={`w-full font-bold py-3.5 rounded-xl transition-all ${isValid && !isChecking ? 'bg-gradient-to-r from-indigo-500 to-blue-600 text-white shadow-lg shadow-blue-500/25 hover:scale-[1.02]' : 'bg-gray-700 text-gray-500 cursor-not-allowed'}`}
                >
            ...
            {showDuplicateModal && duplicateMemberInfo && (
                <div className="fixed inset-0 bg-black/80 flex justify-center items-center z-[70] p-4">
                    <div className="bg-gray-800 rounded-2xl w-full max-w-sm border border-red-500/50 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="p-5">
                            ...
                            <div className="bg-gray-900/50 rounded-xl p-4 border border-gray-700 mb-5">
                                <p className="text-white font-bold text-lg mb-1">{duplicateMemberInfo.name}</p>
                                <p className="text-gray-400 text-xs mb-1">ID: {duplicateMemberInfo.memberId}</p>
                                <p className={`text-xs font-bold ${duplicateMemberInfo.status === 'Active' ? 'text-green-400' : 'text-red-400'}`}>
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="flex-1 py-2.5 rounded-xl font-bold text-gray-300 hover:text-white bg-gray-700 hover:bg-gray-600 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
